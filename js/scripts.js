...
const ASSETS = [
    ...
    // --- 02_CONSUMO ---
    { id: 'barra-larga', nombre: 'Barra Larga', tag: '02_CONSUMO', img: 'img/Barra_Larga_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Barra_Larga.glb', specs: { 'Polígonos': '3278', 'Materiales': 'Madera, Metal', 'Peso': '4.4 MB' } },
    { id: 'barra-comunal', nombre: 'Mesa Comunal', tag: '02_CONSUMO', img: 'img/Barra_Comunal_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Barra_Comunal.glb', specs: { 'Polígonos': '568', 'Materiales': 'Madera tratada', 'Peso': '10.6 MB' } },
    { id: 'sofa-exterior', nombre: 'Sofa Exterior', tag: '02_CONSUMO', img: 'img/Ext_Sofa_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Ext_Sofa.glb', specs: { 'Polígonos': '2668', 'Materiales': 'Tapizado, Metal', 'Peso': '13.1 MB' } },
    { id: 'banco-decorativo', nombre: 'Banco Decorativo', tag: '02_CONSUMO', img: 'img/Ext_BancoDecorativo_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Ext_BancoDecorativo.glb', specs: { 'Polígonos': '2896', 'Materiales': 'Madera, Acero', 'Peso': '2.0 MB' } },
    { id: 'mesa-centro', nombre: 'Mesa Centro', tag: '02_CONSUMO', img: 'img/Ext_Mesa_Centro_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Ext_Mesa_Centro.glb', specs: { 'Polígonos': '568', 'Materiales': 'Vidrio, Metal', 'Peso': '5.5 MB' } },
    ...
    { id: 'banco-exterior', nombre: 'Banco Exterior', tag: '02_CONSUMO', img: 'img/Ext_Banco_02_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Ext_Banco.glb', specs: { 'Polígonos': '—', 'Materiales': 'Madera, Metal', 'Peso': '17.5 MB' } },
    { id: 'silla_v2', nombre: 'Silla V2', tag: '02_CONSUMO', img: 'img/Ext_Silla_V2_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_zonas_de_consumo/Ext_Silla_V2.glb', specs: { 'Polígonos': '2192', 'Materiales': 'Polipropileno, Cojín, Metal', 'Peso': '5.8 MB' } },
    
    // --- 03_MAQUINARIA ---
    { id: 'cafetera-futurista', nombre: 'Cafetera Futurista', tag: '03_MAQUINARIA', img: 'img/Cafetera_Futurista_Industrial_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Cafetera_Futurista_Industrial.glb', specs: { 'Polígonos': '—', 'Materiales': '—', 'Peso': '34.2 MB' } },
    { id: 'greca', nombre: 'Greca', tag: '03_MAQUINARIA', img: 'img/Greca_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Greca.glb', specs: { 'Polígonos': '—', 'Materiales': '—', 'Peso': '26.0 MB' } },
    { id: 'licuadora', nombre: 'Licuadora', tag: '03_MAQUINARIA', img: 'img/Licuadora_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Licuadora.glb', specs: { 'Polígonos': '—', 'Materiales': '—', 'Peso': '32.9 MB' } },
    { id: 'maquina-cafe', nombre: 'Máquina de Café', tag: '03_MAQUINARIA', img: 'img/Maquina_de_Cafe_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Maquina_de_Cafe.glb', specs: { 'Polígonos': '—', 'Materiales': '—', 'Peso': '38.2 MB' } },
    { id: 'maquina-cafe-futurista', nombre: 'Máquina de Café Futurista 02', tag: '03_MAQUINARIA', img: 'img/Maquina_de_Cafe_Futurista_02_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Maquina_de_Cafe_Futurista_02.glb', specs: { 'Polígonos': '—', 'Materiales': '—', 'Peso': '30.1 MB' } },
    { id: 'fregadero-barista', nombre: 'Fregadero Estación Barista', tag: '03_MAQUINARIA', img: 'img/Fregadero_Estacion_Barista_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Fregadero_Estacion_Barista.glb', specs: { 'Polígonos': '1190', 'Materiales': 'Acero inoxidable, Metal', 'Peso': '3.8 MB' } },
    { id: 'molino-cafe-limpio', nombre: 'Molino de Café Limpio', tag: '03_MAQUINARIA', img: 'img/Molino_Cafe_Limpio_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/Molino_Cafe_Limpio.glb', specs: { 'Polígonos': '684', 'Materiales': 'Metal, Plástico', 'Peso': '1.7 MB' } },
    { id: 'molino-cafe-cables', nombre: 'Molino de Café con Cables', tag: '03_MAQUINARIA', img: 'img/MolinoCafe_Cables_screenshot.png', glb: 'https://raw.githubusercontent.com/andrtarazona11-arch/unlock_studio/main/modelos_maquinaria_preparacion/MolinoCafe_Cables.glb', specs: { 'Polígonos': '5644', 'Materiales': 'Metal, Caucho', 'Peso': '3.2 MB' } },
